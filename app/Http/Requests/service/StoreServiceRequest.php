...
class StoreServiceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'service' => 'required|string|min:1|max:150|regex:/^[A-Za-zÁÉÍÓÚÜÑñáéíóúü\s\']+$/u',
    ...
    {
        return [
            'type_service_id.required' => 'El tipo de servicio es obligatorio.',
            'type_service_id.exists' => 'El tipo de servicio seleccionado no es válido.',

            'service.required' => 'El nombre del servicio es obligatorio.',
