...
class UpdateUserRequest extends FormRequest
{
    ...
    {
        return [
            //'user_type_id' => 'sometimes|integer|exists:types_user,id',
            'name' => 'sometimes|string|max:55|regex:/^[A-Za-zÑñÁÉÍÓÚáéíóú\s\']+$/',
            'last_name' => 'sometimes|string|max:55|regex:/^[A-Za-zÑñÁÉÍÓÚáéíóú\s\']+$/',
            'last_name2' => 'sometimes|nullable|string|max:55|regex:/^[A-Za-zÑñÁÉÍÓÚáéíóú\s\']+$/',
            'email' => [
                'sometimes',
                'email',
                'regex:/^[^@]+@[^@]+\.[^@]+$/',
