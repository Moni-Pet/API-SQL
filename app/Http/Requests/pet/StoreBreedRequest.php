...
class StoreBreedRequest extends FormRequest
{
    ...
    {
        return [
            'type_pet_id' => 'required|exists:types_pet,id',
            'breed' => 'required|string|max:50|regex:/^[A-Za-zÑñÁÉÍÓÚáéíóú\s\']+$/|unique:breeds,breed',
        ];
    }
    ...
    {
        return [
            'type_pet_id.required' => 'El campo tipo de mascota es obligatorio.',
